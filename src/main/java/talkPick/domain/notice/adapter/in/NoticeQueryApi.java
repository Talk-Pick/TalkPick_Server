...
public interface NoticeQueryApi {
    ...
    CursorPageResponse<NoticeResDTO.NoticeSummary> getNotices(
    ...
    NoticeResDTO.NoticeDetail getNoticeDetail(@PathVariable("id") @NotNull(message = "[ERROR] notice id가 존재하지 않습니다.") Long noticeId);
}