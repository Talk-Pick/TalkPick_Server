...
public interface RandomQueryApi {
    ...
    @Operation(summary = "랜덤 토픽 2 : 랜덤 토픽 카테고리 조회 API", description = "랜덤 토픽 2 : 랜덤 토픽 카테고리 조회 API 입니다. (다음 주제로 버튼 때 사용해도 됩니다.)")
    List<RandomResDTO.Categories> getCategories();

    @GetMapping("/{topicId}")
    @Operation(summary = "랜덤 토픽 4 : 랜덤 토픽 상세 조회 API", description = "랜덤 토픽 4 : 랜덤 토픽 상세 조회 API 입니다.")
